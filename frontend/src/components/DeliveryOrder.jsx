...
const DeliveryOrder = () => {
  ...
  // };
   ...
   const handleViewClick = () => {
     navigate("/delivery-cancelled"); // Navigate to the delivery-cancelled URL
   };
 const handleViewTClick = () => {
   navigate("/delivery-tracking"); // Navigate to the delivery-tracking URL
 };
