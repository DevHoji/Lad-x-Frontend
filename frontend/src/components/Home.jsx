...
const Home = () => {
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      {/* Right Section */}
      <Box sx={{ flex: 1, backgroundColor: "#F5F5F5", padding: "20px", marginTop:'60px' }}>
        {/* Boxes Section */}
{/* Parent Container */}
<Box
  sx={{
...
>
  <Box
    sx={{
      ...
      maxWidth: { xs: "100%", sm: "calc(50% - 20px)", md: "calc(33.33% - 20px)" }, // Limit on larger screens
  ...
  >
    ...
    >
      ...
      <ArrowDropDownIcon sx={{ color: "#F66F1E", fontSize: { xs: "18px", md: "20px" }, marginLeft: "5px" }} />
    </Box>
    ...
    <Typography
      sx={{ color: "#210947", fontSize: { xs: "12px", md: "14px" }, marginTop: "5px" }}
    >
...
>
  ...
  >
    <Typography sx={{ fontWeight: "bold", fontSize: { xs: "12px", md: "16px" } }}>
  ...
  >
    ...
    <InputBase placeholder="Search" sx={{ marginLeft: "10px", flex: 1 }} />
  </Box>

  {/* Item List */}
  <Box sx={{ marginBottom: "20px" }}>
    {["Hand Bags", "Gadgets", "Food Items", "Hand Bags"].map((item, index) => (
      <Box
        key={index}
        sx={{
      ...
      >
        ...
        <Box sx={{ display: "flex", alignItems: "center" }}>
          <Checkbox size="small" />
          <Typography sx={{ marginLeft: "10px", fontSize: { xs: "14px", md: "16px" } }}>{item}</Typography>
        </Box>
        ...
        <Box sx={{ display: "flex", alignItems: "center" }}>
          ...
          <Typography sx={{ fontSize: { xs: "14px", md: "16px" } }}>
            {["Sam Kethin", "John Durelo", "Leila Adebayo", "Sam Kethin"][index]}
          </Typography>
        </Box>
