...
const ProfileT = () => {
 ...
 const states = ["California", "Texas", "Florida", "New York","Kigali"];
  ...
  const handleAccoTClick = () => {
    navigate("/account-settings"); // Use navigate to go to AccountSettingsT
  };
    ...
    <TravelerLayout>
      ...
      >
        ...
        <Box
          ...
          onClick={handleAccoTClick} // Navigate to Account Settings on click
        >
          <PersonOutlineIcon
            sx={{
              fontSize: 30,
        ...
        >
          <SwapHorizIcon // Change the icon here
            sx={{
              fontSize: 30,
              color: "black",
              backgroundColor: "#F5F5F5",
